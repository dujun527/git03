 ...
 *   Date:2017/7/30
 */
define(["jquery","text!tpls/teacherList.html","template","teacher/show","teacher/add"],function($,teacherListTpl,template,teacherShow,teacherAdds){
    //1、获取讲师列表模板的内容
        ...
        $.ajax({
            ...
            success:function(res){
               ...
               //点击查看功能
                ...
                $(".menu-content").on("click","#addTeacher",function () {
                    teacherAdds();
                })
